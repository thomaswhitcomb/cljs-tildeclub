(ns tildeclub.cljs.core
  (:require [tildeclub.cljs.gol :as gol]
...
(defn render [{universe :universe iterations :iterations}]
  (do
      ;(set!-content)
      (dom/add-event-listener iterations "keyup" keyup)
      (dom/add-event-listener universe "keyup" keyup)))
